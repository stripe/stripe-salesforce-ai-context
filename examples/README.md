...
```bash
# Clone this repo
git clone https://github.com/stripe/stripe-salesforce-ai-context.git
cd stripe-salesforce-ai-context/examples
...
1. Open your AI tool in the repo directory and prompt: "Read all files in context/ and become my Stripe-Salesforce integration expert. When ready, tell me what you loaded."
2. Then prompt your task: "Generate a Flow that creates a Stripe Subscription when Contract activates"
